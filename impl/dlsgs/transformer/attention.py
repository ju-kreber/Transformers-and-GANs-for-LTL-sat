...
class MultiHeadAttention(tf.keras.layers.Layer):
    ...
    def __init__(self, d_embedding, num_heads, dtype='float32'):
    ...
    def call(self, queries, keys, values, mask=None, cache=None):
        ...
        scaled_attention, attention_weights = scaled_dot_product_attention(
            queries, keys, values, mask, dtype=self.my_dtype)  # (batch_size, num_heads, num_queries, d_heads) (batch_size, num_heads, num_queries, num_keys)
